...
1. 从 [GitHub Release](https://github.com/wrangler1024/crossborder-userscripts/releases/tag/dxm-purchase-assistant-v0.1.44) 下载 `xynigo-dxm-purchase-assistant-v0.1.44.zip`。
2. 完整解压 ZIP，不要直接从压缩包内打开文件。
3. 在浏览器地址栏打开 `chrome://extensions/`。
4. 开启右上角“开发者模式”。
5. 点击“加载已解压的扩展程序”。
6. 选择解压得到的 `xynigo-dxm-purchase-assistant-v0.1.44` 文件夹；该文件夹内应直接看到 `manifest.json`。
7. 刷新店小秘待审核订单页面。
