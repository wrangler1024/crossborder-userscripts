...
USERSCRIPT_PATH="$REPO_ROOT/scripts/shein-batch-shelf/shein_removed_shelves.user.js"
MASCOT_PATH="$REPO_ROOT/assets/xynigo-mascot.png"
OUTPUT_DIR="$REPO_ROOT/dist"
DEV_DIR="$OUTPUT_DIR/xynigo-shein-batch-shelf-dev"
...
PACKAGE_NAME="xynigo-shein-batch-shelf-v$MANIFEST_VERSION"
...
if [ "$MODE" = "--release" ] || [ "$MODE" = "--all" ]; then
    TEMP_ROOT=$(mktemp -d "${TMPDIR:-/tmp}/xynigo-shein-batch-shelf.XXXXXX")
