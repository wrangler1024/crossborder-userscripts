...
const output = [
  ...
  runtime,
  '',
  `globalThis.XynigoDxmUserscriptRuntime.boot(globalThis, ${JSON.stringify(css)}, ${JSON.stringify(manifest.version)}, globalThis.XynigoDxmUserscriptRuntime.browserAdapters(), globalThis.XynigoDxmBackground);`,
  '',
  core,
  '',
  content,
