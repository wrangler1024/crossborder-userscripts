...
| **Xynigo 店小秘运营采购助手** | 在店小秘待审核订单详情中录入逐商品采购链接、规格、指导价和采购数量，并计算预估采购成本与利润指标 | **v0.1.44·公开预览** | **[Chrome + Comet 通用包](https://github.com/wrangler1024/crossborder-userscripts/releases/download/dxm-purchase-assistant-v0.1.44/xynigo-dxm-purchase-assistant-v0.1.44.zip)** | [功能说明](./extensions/xynigo-dxm-purchase-assistant/README.md) |
