...
| **SHEIN 店铺接码助手** | SHEIN 登录首次自动发码或人工获取验证码后，轮询店铺独立接码链接并自动填入验证码，确认登录由运营手动完成 | **v0.1.1·HubStudio 验收可用** | **HubStudio 团队扩展：SHEIN 店铺接码助手** | [功能说明](./extensions/xynigo-shein-store-otp-assistant/README.md) |
